  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Secure your property with NEHA Solar Power Fence. Premium, cost-effective, and smart solar-powered fencing systems for agricultural farms and industries across Madurai, Tamil Nadu." />
        <meta name="keywords" content="solar power fence Madurai, security fencing solutions, farm fencing Tamil Nadu, automatic power fences, cost effective solar guard" />
        
        {/* Open Graph Social Sharing Configurations */}
        <meta property="og:title" content="NEHA Solar Power Fence | Secure Today, Protect Tomorrow" />
        <meta property="og:description" content="Industrial and agricultural solar power fence systems engineered for maximum protection and durability." />
      ...
      >
        {/* Pure Emerald Radian Ambient Backdrop Lighting — Zero Blue Tints */}
        ...
        <div className='relative z-10 w-full max-w-7xl mx-auto'>
          ...
          <div className='flex items-center gap-3 mb-6'>
            <div className='bg-emerald-500 w-11 h-11 rounded-full flex items-center justify-center text-zinc-950 font-bold shadow-lg shadow-emerald-500/20'>
              <svg className="w-5 h-5 stroke-zinc-950 fill-none stroke-[2]" viewBox="0 0 24 24">
...
>
  ...
  <span className='relative z-10 flex items-center justify-center gap-2'>
    Get Free Quote →
            ...
            <button
              className='group border border-zinc-800 bg-zinc-900/30 backdrop-blur-sm px-8 py-4 rounded-xl text-white font-semibold relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/30 hover:bg-zinc-900/60'
          ...
          {/* Neutral Charcoal Feature Cards Grid */}
